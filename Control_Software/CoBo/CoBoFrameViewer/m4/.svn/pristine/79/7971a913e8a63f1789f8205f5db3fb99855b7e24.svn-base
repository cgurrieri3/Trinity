...
then
	...
	icelibs_variants='-l$1,-l$1 -l$1Util,-lZeroCIce,-lZeroCIce -lIceUtil,-lZerocIce -lZerocIceUtil'
	set -f; as_save_IFS=$IFS; IFS=','
	for ICE_LIBS in $icelibs_variants
	do
		set +f; IFS=$as_save_IFS
