...
instead" >&AS_MESSAGE_LOG_FD
  ...
  # Define MOC flags
  AC_CACHE_CHECK([for flags to use with moc], [at_cv_env_QT_MOCFLAGS],
  [at_cv_env_QT_MOCFLAGS=`echo $at_cv_env_QT_INCPATH | sed "s/-isystem /-I/g"`])
  AC_SUBST([QT_MOCFLAGS], [$at_cv_env_QT_MOCFLAGS])
...
[ AC_PREREQ([2.60])
  ...
  qmake_version_sed=['/^.*\([0-9]\.[0-9]\{1,\}\.[0-9]\{1,\}\).*$/!d;s//\1/']
