# $Id: ax_lib_qwtplot3d.m4 1990 2018-11-29 08:09:03Z psizun $
#
...
[
	...
	if test "x$want_qwt_plot_3d" = "xyes"; then
		...
		incdirnames="qwtplot3d qwtplot3d-qt5 qwtplot3d-qt4"
		...
		if test "$qwt_plot_3d_header_found" != "no"; then
			...
			libnames="qwtplot3d qwtplot3d-qt5 qwtplot3d-qt4"

			for libname in $libnames ; do
				QWT_PLOT_3D_LIBS="-l$libname"
