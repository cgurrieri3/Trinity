...
#define CMD_BMX_CONFIG				0x26
#define CMD_BMX_ENABLE_LOG			0x27
#define CMD_BMX_DISABLE_LOG			0x28
#define CMD_BMX_Arxive_DL			0x29
...
void BMX_Configure(int file, __u32 command, std::string &response);
#endif
