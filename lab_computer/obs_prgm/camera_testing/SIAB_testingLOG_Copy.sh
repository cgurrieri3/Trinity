...
local_file="/home/mpotts32/obs_prgm/camera_testing/"
remote_path="/home/trinity/Programs/PixelTesting/testSIABs.log"
...
scp -i ~/.ssh/CTCPU "$remote_user@$remote_server:$remote_path" "$local_file"
