...
def get_array(m_hex):
    LENGTHS = [2,2,4,8,4,4,4,4,8,8,8,8,2,2,2,2,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2]
    results = []
    start = 0
    #print(m_hex)
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        #print(file)
        current_file = '/home/trinity/Programs/Trinity/control_software/Archive/LOGS/SM_LOG.bin'
